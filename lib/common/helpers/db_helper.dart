...
class DBHelper {
  ...
  static Future<sql.Database> db() async {
    return sql.openDatabase('taskManagementDB', version: 1, onCreate: (sql.Database database, int version) async {
  ...
  static Future<int> createItem(Task task) async {
    ...
    final id = await db.insert('todos', task.toJson(), conflictAlgorithm: sql.ConflictAlgorithm.replace);
    return id;
  }
